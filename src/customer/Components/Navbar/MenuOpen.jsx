...
const sidebarItems = [{name:"LOG IN / REGISTER",link:"/sign-in"},{name:"MY ACCOUNT",link:"/my-account"}, {name:"MY ORDERS",link:"/my-orders"}, {name:"MY STORE CREDIT",link:"./my-store-credit"} ];
